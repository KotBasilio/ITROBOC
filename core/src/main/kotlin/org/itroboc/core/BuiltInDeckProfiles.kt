    ...
    fun observedV1(): DeckProfile =
        DeckProfile(
            signatureToCard = buildMap {
                ...
                addObserved(CardId(Suit.SPADES, Rank.ACE), "bfm1549", "brm1255")
                ...
                addObserved(CardId(Suit.SPADES, Rank.EIGHT), "bfm1529", "brm1295")
                ...
                addObserved(CardId(Suit.HEARTS, Rank.QUEEN), "bfm1535", "brm1595")
                ...
                addObserved(CardId(Suit.HEARTS, Rank.SEVEN), "bfm1595", "brm1535")
                addObserved(CardId(Suit.HEARTS, Rank.SIX), "bfm1195", "brm1531")
                addObserved(CardId(Suit.HEARTS, Rank.FIVE), "bfm1495", "brm1525")
                addObserved(CardId(Suit.HEARTS, Rank.FOUR), "bfm1295", "brm1529")
                addObserved(CardId(Suit.HEARTS, Rank.THREE), "bfm1235", "brm1589")
                ...
                addObserved(CardId(Suit.DIAMONDS, Rank.JACK), "bfm1655", "brm154D")
                addObserved(CardId(Suit.DIAMONDS, Rank.TEN), "bfm1255", "brm1549")
                ...
                addObserved(CardId(Suit.DIAMONDS, Rank.FIVE), "bfm1565", "brm14D5")
                addObserved(CardId(Suit.DIAMONDS, Rank.FOUR), "bfm1265", "brm14C9")
                addObserved(CardId(Suit.DIAMONDS, Rank.THREE), "bfm154D", "brm1655")
                ...
                addObserved(CardId(Suit.CLUBS, Rank.TWO), "bfm1499", "brm1325")
            },
            metadata = DeckProfileMetadata(
                ...
                isBuiltIn = true,
                isDemo = false,
                notes = "Observed grid13-v1 profile from scan logs, with S6/C6 resolved by focused rescan and bfm/brm orientation visually verified against the physical deck.",
